    ...
    >
      <div className={styles.bookingTriageInner}>
        <article className={styles.bookingTriageIntro}>
          <p className={styles.bookingTriageEyebrow}>PRIVATE TOUR PLANNER</p>
          <h2 id="booking-triage-title" className={styles.bookingTriageTitle}>
            Plan Your Private Rome Tour in a Few Easy Steps
          </h2>
          <p className={styles.bookingTriageLead}>
            Pick your dates, choose your interests in Rome or beyond, and share a few details.
            We&apos;ll prepare a custom proposal for your private tour.
          </p>
          <p className={styles.bookingTriageMicro}>
            Human support | Flexible routes | Fast reply
          </p>

          <ul className={styles.triageSteps} aria-label="Tour planning steps">
                ...
                <div className={styles.optionalPanel}>
                  ...
                  <label className={styles.fieldWrap}>
                    ...
                    <textarea
                      ...
                      rows={3}
                      placeholder="Timing needs, accessibility notes, or special requests."
                    />
                  </label>
                </div>
              ) : null}
