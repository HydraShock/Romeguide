...
const trustHighlights = [
  { value: "10+", label: "Years Guiding Guests" },
  { value: "1000+", label: "Happy Travelers" },
  { value: "1500+", label: "Private Tours Delivered" },
] as const;
          ...
          <div className={styles.contentLayer}>
            <div className={styles.copyBlock}>
              ...
              <p className={styles.description}>
                From Ancient Rome and Vatican private tours to day trips from Rome,
                we create custom itineraries that match your pace and interests.
              </p>
